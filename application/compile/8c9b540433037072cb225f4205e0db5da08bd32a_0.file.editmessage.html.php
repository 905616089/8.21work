...
function content_5f578292210da8_73065037 (Smarty_Internal_Template $_smarty_tpl) {
?><!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
'>
            ...
            <div class="form-group">
                ...
                <input type="email" name="email" id="email" class="form-control" value='<?php echo $_smarty_tpl->tpl_vars['data']->value["email"];?>
'>
            </div>
            <div class="form-group">
