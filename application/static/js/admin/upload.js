class upload{
  constructor(){
    ...
    this.filename="file";
    this.selectBtnStyle="width:100px;height:30px;border-radius:10px;background:#3c763d;color:white; margin-bottom: 10px;";
    this.selectBtnCon="选择图片";

    this.upBtnStyle="width:100px;height:30px;border-radius:10px;background:#ccc;clear:both; "
    this.upBtnCon="确定上传";
